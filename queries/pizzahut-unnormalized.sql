...
(1, 'John Doe',      '111-111-1111', 'Boulder', 80303),
(2, 'Cindy Smith',   '111-222-2222', 'Boulder', 80303),
(3, 'Elmer Jones',   '111-333-3333', 'Boulder', 80303),
(4, 'Ralph Watson',  '111-444-4444', 'Boulder', 80303),
(5, 'Sheefali Tewari', '111-555-5555', 'Broomfield', 80020),
(6, 'Louis Bouddhou','111-666-6666', 'Boulder', 80304),
(7, 'Josh Fermin',   '111-777-7777', 'Boulder', 80304),
(8, 'Alex Campbell', '111-888-8888', 'Boulder', 80304),
(9, 'Edward Zhu',    '111-999-9999', 'Boulder', 80304);
...
CREATE TABLE orders
(
    -- order_id detmines all other ids
    -- customer id determines area
...
(8, 'Pepperoni', 'Boulder'),
(8, 'Cheese', 'Boulder'),
(1, 'Pepperoni', 'Broomfield'),
(1, 'Supreme', 'Broomfield');
